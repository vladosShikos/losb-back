"""
Django settings for losb project.
...
SECRET_KEY = env.str('SECRET_KEY', default='django-insecure-70olb1f#nd4p3vcb^vs!jb5nnu5x4^$mp@+5e5+&n#btr^3(f^')
...
WSGI_APPLICATION = 'losb.wsgi.application'
